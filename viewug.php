...
$stmt = $dbh->prepare('SELECT packageid, packagetitle, packagedesc, itinerary, inclusion, packageimg, exclusion, toursummary FROM ugandapackage WHERE packageid = :packageid');
