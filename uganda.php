...
<head>
<title>Paradise Africa Expeditions | Uganda</title>
...
<div class="breadcrumb-area" style="background-image: url(assets/images/Uganda11.jpg); background-repeat: no-repeat; background-size: cover; background-position: center; background-attachment: fixed;">
<div class="container">
<div class="row">
<div class="col-lg-12 col-md-12 col-sm-12">
<div class="breadcrumb-wrap">
<h2>Uganda Safaris</h2>
...
<?php $sql = "SELECT * from ugandapackage order by rand() limit 15";
...
{	?>
  <a href="viewug.php?id=<?php echo htmlentities($result->packageid);?>">
