...
$stmt = $dbh->prepare('SELECT packageid, packagetitle, packagedesc, itinerary, inclusion, packageimg, exclusion, toursummary FROM kenyapackage WHERE packageid = :packageid');
