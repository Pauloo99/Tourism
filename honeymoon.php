...
<div class="breadcrumb-area" style="background-image: url(assets/images/valentinerhino.jpg); background-repeat: no-repeat; background-size: cover; background-position: center;">
<div class="container">
<div class="row">
...
<?php $sql = "SELECT * from honeymoon order by rand() limit 15";
...
{	?>
  <a href="viewhoneymoon.php?id=<?php echo htmlentities($result->packageid);?>">
