...
<head>
<title>Paradise Africa Expeditions | Tanzania</title>
...
<div class="breadcrumb-area" style="background-image: url(assets/images/Tanzania11.jpg); background-repeat: no-repeat; background-size: cover; background-position: center; background-attachment: fixed;">
<div class="container">
<div class="row">
...
<?php $sql = "SELECT * from tanzaniapackage order by rand() limit 15";
...
{	?>
  <a href="viewtz.php?id=<?php echo htmlentities($result->packageid);?>">
