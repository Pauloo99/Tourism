...
<div class="breadcrumb-area" style="background-image: url(assets/images/sarovabg.jpg); background-repeat: no-repeat; background-size: cover; background-position: center; background-attachment: fixed;">
<div class="container">
<div class="row">
<div class="col-lg-12 col-md-12 col-sm-12">
<div class="breadcrumb-wrap">
<h2>Hotel and Lodge Bookings</h2>
...
<div class="w3-bar w3-black tab">
  <button class="w3-bar-item w3-button w3-padding-16 tablink active" style="" onclick="openCity(event, 'London')" id="defaultOpen">Hotels</button>
  <button class="w3-bar-item w3-button w3-padding-16 tablink" onclick="openCity(event, 'Paris')">Lodges</button>
</div>

<div id="London" class="w3-container w3-animate-opacity city">
  <div class="package-area pt-120">
<div class="container">
<div class="row">
<div class="col-lg-12 col-md-12 col-sm-12">
<div class="section-head pb-45">
<h3 style="letter-spacing: 5px;">HOTELS</h3>
</div>
</div>
</div>
</div>
...
<?php $sql = "SELECT * from hotels order by rand() limit 15";
...
{ ?>
  <a href="viewkenya.php?id=<?php echo htmlentities($result->hotelid);?>">
  <div class="w3-card-4" style="width:30%; display: inline-block; margin: 1.5%; height: auto;"  >
      <img src="admin/pacakgeimages/<?php echo htmlentities($result->packageimage);?>" style="width: 100%; height: auto; max-height: 220px;" class="img-fluid" alt="" >
    <div class="w3-container w3-center">
          <h5 style="margin: 5% 0.3%; "><?php echo htmlentities($result->hotelname);?></h5>
      </div>
    </div>
...
<div id="Paris" class="w3-container w3-animate-opacity city" style="display:none">
 <div class="package-area pt-120">
<div class="container">
<div class="row">
<div class="col-lg-12 col-md-12 col-sm-12">
<div class="section-head pb-45">
<h3 style="letter-spacing: 5px;">LODGES</h3>
</div>
</div>
</div>
</div>
...
<div style="width: 100%;" class="w3-hide-small">
<div style=" width: 90%; margin: auto;">
<?php $sql = "SELECT * from logdes order by rand() limit 15";
$query = $dbh->prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
foreach($results as $result)
{ ?>
  <a href="viewkenya.php?id=<?php echo htmlentities($result->lodgeid);?>">
  <div class="w3-card-4" style="width:30%; display: inline-block; margin: 1.5%; height: auto;"  >
      <img src="admin/pacakgeimages/<?php echo htmlentities($result->lodgeimage);?>" style="width: 100%; height: auto; max-height: 220px;" class="img-fluid" alt="" >
    <div class="w3-container w3-center">
          <h5 style="margin: 5% 0.3%; "><?php echo htmlentities($result->lodgename);?></h5>
      </div>
    </div>
