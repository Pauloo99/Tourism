...
$sql="update TblTourPackages set PackageName=:pname, where PackageId=:pid";
...
<html>
<head>
<title>PAE | Package Creation</title>
...
<div class="form-group">
<label for="focusedinput" class="col-sm-2 control-label">Package Image <br> size: 370 x 225</label>
<div class="col-sm-8">
