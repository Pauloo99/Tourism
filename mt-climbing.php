...
<div class="breadcrumb-area" style="background-image: url(assets/images/SIRIMON-CHOGORIA.jpg); background-repeat: no-repeat; background-size: cover; background-position: center; background-attachment: fixed;">
<div class="container">
<div class="row">
...
<?php $sql = "SELECT * from mclimbing order by rand() limit 15";
...
{	?>
  <a href="view-mt-climbing.php?id=<?php echo htmlentities($result->packageid);?>">
